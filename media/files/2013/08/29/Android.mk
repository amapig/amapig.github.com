...
AVCODEC_C_FILES-$(CONFIG_AC3_ENCODER) += ac3enc_fixed.c ac3enc_float.c ac3tab.c ac3.c kbdwin.c ac3enc.c
AVCODEC_C_FILES-$(CONFIG_AC3_FLOAT_ENCODER) += ac3enc_float.c ac3tab.c ac3tab.c ac3.c kbdwin.c
AVCODEC_C_FILES-$(CONFIG_AC3_FIXED_ENCODER) += ac3enc_fixed.c ac3tab.c ac3tab.c ac3.c ac3enc.c
...
AVCODEC_C_FILES-$(CONFIG_MPEG1VIDEO_ENCODER) += mpeg12enc.c mpegvideo_enc.c \
    ...
    mpegvideo.c error_resilience.c timecode.c
...
AVCODEC_C_FILES-$(CONFIG_SNOW_ENCODER) += snowenc.c snow.c rangecoder.c motion_est.c \
...
AVCODEC_C_FILES-$(CONFIG_ADPCM_SWF_ENCODER) += adpcmenc.c
...
AVFORMAT_C_FILES = stagefrightprotocol.c \
    allformats.c \
    cutils.c \
    id3v1.c \
    id3v2.c \
...
AVFORMAT_C_FILES-$(CONFIG_AVI_DEMUXER) += avidec.c riff.c
AVFORMAT_C_FILES-$(CONFIG_AVI_MUXER) += avienc.c riff.c
...
AVFORMAT_C_FILES-$(CONFIG_GSM_DEMUXER) += rawdec.c
...
AVFORMAT_C_FILES-$(CONFIG_MOV_DEMUXER) += mov.c riff.c isom.c mov_chan.c
